...
Сложности: В процессе объявления переменных во втором параметре функции createSelector, я перепутал их последовательность, что привело к ошибкам в фильтрации, однако баг был довольно быстро найден и устранен.
